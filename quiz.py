...
pergunta_5 = ("Qual é uma consequências do desmatamento na Amazônia?", "a)A diminuição do oxigênio na atmosfera, podendo causar asfixia","b)O desaparecimento dos rios voadores, o que causa secas no Sudeste e no Sul", "c)A diminuição da população de tigres e raposas", "d)Aumento do preço do pedágio na Transamazônica", "e)Aumento do risco de Extinção das Coníferas","B",2, "Apesar da Amazônia produzir muito oxigênio, grande parte dele é consumido por ela mesma. As principais produtoras de oxigênio são as algas marinhas.", "Os rios voadores consistem em massas de ar carregadas com água provenientes da evapotranspiração na Amazônia. Os ventos carregam estas massar em direção ao sudeste e sul do país, sendo responsáveis pelo aumento de até 60% da umidade nessas regiões. O desmatamento exarcebado atrapalha este processo, afetando gravemente o clima delas.", "As únicas espécies similares a raposas no Brasil se encontram no Cerrado. Não há tigres na Amazônia.", "O desmatamento não irá levar a um aumento no pedágio da Transamazônica, mas sua construção contribuiu para a aceleração do processo de degradação ambiental da floresta.","As coníferas são comuns em climas frios, como no sul do Brasil e no hemisfério norte. Não existem árvores coníferas na Floresta Amazônica.")
...
pergunta_8 = ("Quais dos listados abaixo não causa poluição atmosférica:", "a)Monóxido de Carbono","b)Dióxido de Enxofre", "c)Chumbo", "d)Dióxido de Nitrogênio", "e)Hidrogênio","E",2, "O monóxido de carbono (CO) é encontrado na atmosfera quando ocorre uma combustão incompleta de combustíveis de carbono, com falta de oxigênio na formação do dióxido de carbono (CO2).", "O dióxido de carbono (SO2) é emitido pelo uso de combustiveis fósseis (via usinas eletricas).",  "A emissão do chumbo (Pb) chega à atmosfera através do uso de combustivel.", "O Dióxido de Nitrogênio (NO2) chega à atmosfera na queima de combustível.", "O hidrogênio não causa poluição atmosférica.")
pergunta_9 = ("Nos últimos 200 anos, o nível de dióxido de carbono na atmosfera tem:","a)Aumentado firmemente.","b)Diminuido firmemente.","c)Oscilado.","d)Aumentado porém com um declínio nos últimos anos.","e)Sem mudança.","A", 1,"Atividades humanas, principalmente na queima de combustíveis, contribuiu nos ultimos anos no aumento do CO2 atmosférico, sem previsão de cessar as atividades.","Atividades humanas, principalmente na queima de combustíveis, contribuiu nos ultimos anos no aumento do CO2 atmosférico, logo aumentando o nível de CO2.","Atividades humanas, principalmente na queima de combustíveis, contribuiu nos ultimos anos no aumento do CO2 atmosférico, sem diminuição das atividades para que ocorra uma oscilação.","Atividades humanas, principalmente na queima de combustíveis, contribuiu nos ultimos anos no aumento do CO2 atmosférico, sem diminuição das atividades para que o nível de CO2 diminua.", "Atividades humanas, principalmente na queima de combustíveis, contribuiu nos ultimos anos no aumento do CO2 atmosférico, atividades que aumentaram o impacto com os anos.")
